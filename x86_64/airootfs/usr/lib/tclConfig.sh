...
TCL_EXTRA_CFLAGS='-march=x86-64 -mtune=generic -O2 -pipe -fno-plt -pipe -m64 -D_FORTIFY_SOURCE=2'
...
TCL_LD_FLAGS='-Wl,-O1,--sort-common,--as-needed,-z,relro,-z,now -Wl,--export-dynamic '
