 ...
 * @providers: (in): the 'Providers' field, given as an array of #MbimProvider items.
 * @error: return location for error or %NULL.
 *
 ...
 * @events: (in): the 'Events' field, given as an array of #MbimEventEntry items.
 * @error: return location for error or %NULL.
 *
 ...
 * @packet_filters: (in): the 'PacketFilters' field, given as an array of #MbimPacketFilter items.
 * @error: return location for error or %NULL.
 *
