...
#define BRL_CMD_INDICATORS (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_INDICATORS)
/** clear the text selection */
#define BRL_CMD_TXTSEL_CLEAR (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_TXTSEL_CLEAR)
/** select all of the text */
#define BRL_CMD_TXTSEL_ALL (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_TXTSEL_ALL)
/** copy selected text to host clipboard */
#define BRL_CMD_HOST_COPY (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_HOST_COPY)
/** cut selected text to host clipboard */
#define BRL_CMD_HOST_CUT (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_HOST_CUT)
/** insert host clipboard text after screen cursor */
#define BRL_CMD_HOST_PASTE (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_HOST_PASTE)
/** show the window title */
#define BRL_CMD_GUI_TITLE (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_TITLE)
/** open the braille actions window */
#define BRL_CMD_GUI_BRL_ACTIONS (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_BRL_ACTIONS)
/** go to the home screen */
#define BRL_CMD_GUI_HOME (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_HOME)
/** go back to the previous screen */
#define BRL_CMD_GUI_BACK (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_BACK)
/** open the device settings window */
#define BRL_CMD_GUI_DEV_SETTINGS (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_DEV_SETTINGS)
/** open the device options window */
#define BRL_CMD_GUI_DEV_OPTIONS (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_DEV_OPTIONS)
/** open the application list window */
#define BRL_CMD_GUI_APP_LIST (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_APP_LIST)
/** open the application-specific menu */
#define BRL_CMD_GUI_APP_MENU (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_APP_MENU)
/** open the application alerts window */
#define BRL_CMD_GUI_APP_ALERTS (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_APP_ALERTS)
/** return to the active screen area */
#define BRL_CMD_GUI_AREA_ACTV (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_AREA_ACTV)
/** switch to the previous screen area */
#define BRL_CMD_GUI_AREA_PREV (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_AREA_PREV)
/** switch to the next screen area */
#define BRL_CMD_GUI_AREA_NEXT (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_AREA_NEXT)
/** move to the first item in the screen area */
#define BRL_CMD_GUI_ITEM_FRST (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_ITEM_FRST)
/** move to the previous item in the screen area */
#define BRL_CMD_GUI_ITEM_PREV (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_ITEM_PREV)
/** move to the next item in the screen area */
#define BRL_CMD_GUI_ITEM_NEXT (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_ITEM_NEXT)
/** move to the last item in the screen area */
#define BRL_CMD_GUI_ITEM_LAST (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_GUI_ITEM_LAST)
/** decrease speaking pitch */
#define BRL_CMD_SAY_LOWER (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_SAY_LOWER)
/** increase speaking pitch */
#define BRL_CMD_SAY_HIGHER (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_SAY_HIGHER)
/** speak from top of screen through bottom of screen */
#define BRL_CMD_SAY_ALL (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_SAY_ALL)
/** set contracted/computer braille */
#define BRL_CMD_CONTRACTED (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_CONTRACTED)
/** set six/eight dot computer braille */
#define BRL_CMD_COMPBRL6 (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_COMPBRL6)
...
#define BRL_BLK_TXTSEL_START (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_TXTSEL_START)
/** set text selection */
#define BRL_BLK_TXTSEL_SET (BRLAPI_KEY_TYPE_CMD | BRLAPI_KEY_CMD_TXTSEL_SET)
