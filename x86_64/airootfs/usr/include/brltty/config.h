...
#define USE_PKG_RGX_LIBPCRE2_32 1
...
#define HAVE_ATSPI_GET_A11Y_BUS 1
...
#define HAVE_SD_SESSION_GET_VT 1
...
/* Define this to be a string containing the path to the scripts directory. */
#define SCRIPTS_DIRECTORY "/usr/lib/brltty"

/* Define this to be a string containing the path to the tables directory. */
#define TABLES_DIRECTORY "/usr/share/brltty"

/* Define this to be a string containing the path to the LibLouis tables directory. */
#define LOUIS_TABLES_DIRECTORY "/usr/share/liblouis/tables"
...
#define BRAILLE_DRIVER_CODES "al at ba bc bd bl bm bn cb ce cn ec eu fa fs hd hm ht hw ir ic lt mb md mm mn mt np pg pm sk tn ts tt vd vo vr vs xw bg"
...
#define SPEECH_DRIVER_CODES "al bl cb en fv gs sd xs"
